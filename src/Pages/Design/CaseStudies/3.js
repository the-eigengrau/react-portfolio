      ...
      <React.Fragment>
        <div className="caseStudy-container1">
          ...
          <div className="content2">
              <p>Mind-blindness is the biggest obstacle stopping technical people from connecting with their users; when someone has deep knowledge of a domain, it's easy to misperceive the level of understanding others have. An expert has rich context, background, and a deep well of references that cause them to hear a symphony where non-technical people hear crickets.</p>
              <p>Helping my team connect more effectively with our users was a focus for me at KPMG Deal Advisory. I devised a content strategy, branding, and designed/coded a team website and blog.</p>
              ...
              <p>I gained buy-in for my storytelling initiative by having engineers participate directly in the process from the beginning. I picked two of our most respected senior engineers to co-develop materials with me and co-present to the team. The materials showed how to use my principles of good communication and why they were important. We created examples that were directly relevant to the team like launch emails, blog posts, and feature updates. We further broke down the examples in terms of effectiveness and impact.</p>
              <p>I also made sure to describe and emphasize research that shows people can be taught to communicate more impactfully. I know it can be daunting to take on an ambiguous task like telling your story more effectively, and I wanted to make sure people know they can learn how to be great at this. For reference, the principles we emphasized were simplicity, unexpectedness, concreteness, credibility, emotional salience, and story-centricity. I used examples from our own context and also great examples from companies such as Google, SpaceX, Apple, Stripe, and others.</p>
              ...
              <p>The site was coded using Ruby, HTML, CSS, javascript, and a CSS pre-processor called Sass. While I prefer the stack used to code this portfolio site, I did fall atleast partially in love with the bizarre quirks of Ruby,such as monkey-patching and meta-programming.</p>
              <img src={fwblog} className="fwblog"/>
              <p>I had significant cross-browser and cross-platform challenges with coding this site, but using an emulator, and significantly refactoring the code to account for various contextual idiosyncrasies, we were able to launch the site. Sadly, I lost my wireframes due to some technical issues, but these images are good samples of what the site looks like.</p>
