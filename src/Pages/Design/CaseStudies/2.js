      ...
      <React.Fragment>
        <div className="caseStudy-container1">
          ...
          <div className="content2">
              ...
              <p>The small, two year old team that I joined consisted of ten mathematicians, economists, and programmers that had generated a inchoate set of technically brilliant apps which were sorely lacking in effective design and not gaining significant user traction.</p>
              ...
              <p>Systematization was very important on this team for the regular set of reasons, and then a few special ones. Of course, the typical reasons for implementing design systems include consistency, learnability of the interface, credibility with the user, coherence of subsequent designs, and usability. Beyond those common needs, we especially needed to be systematic on this team because I was founding the design team net-new: the system needed to be well thought out to accommodate new designers, to allow me to effectively wear a lot of hats and adapt to the demands of new apps and features, and also to be organized in a sensible way so that I could program the relevant modules with relative ease.</p>
              ...
              <p>My process typically involved speaking to users/stakeholders, sketching some initial ideas and variations, then creating wireframes, and refining the UI over multiple iterations. After that me and another colleague would develop the front-end. In some cases, for completely new features, I would develop the back-end as well. Here's a few sketches from a data-room project I was undertaking:</p>
              ...
              <p>This is an example of a mature UI, leveraging the fullness of our design system. The look and feel has been iterated upon, things are sharper, more professional looking, some of the visual elements are distinct, and some changes have been made to accommodate ease of development:</p>
              <img src={late} className="wireframe1"/>
              <p className="subtitle">PROGRAMMING THE APPS</p>
              <p>I coded the front-end using R/Shiny with significant javascript integrations and a very large amount of custom HTML/CSS. Our team consisted of die-hard R users, so creating modular UI code using Shiny was the easiest way to help them spin up apps to match the wireframes for future projects. I used R and javascript to code certain back-end elements as well, specifically the user data logging API and the contextual help system.</p>
