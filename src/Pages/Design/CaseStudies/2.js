      ...
      <React.Fragment>
        <div className="caseStudy-container1">
          ...
          <div className="content2">
              ...
              <p>Systematization was very important on this team for the regular set of reasons, and then a few special ones. The typical reasons for implementing design systems include consistency, learnability of the interface, credibility with the user, coherence of subsequent designs, and usability. The special reasons we needed to be systematic on this team were tied to the fact that I was founding the design team net-new: the system needed to be well thought out to accommodate new designers, to allow me to effectively wear a lot of hats and adapt to the demands of new apps and features, and also be organized in a sensible way so that I could program the relevant modules with relative ease.</p>
