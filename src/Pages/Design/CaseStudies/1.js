    ...
    return (
      <React.Fragment>
        <div className="caseStudy-container1">
          ...
          <p className="doc3cap">Finding new locations was very important for this user base as well, since Northwestern Medicine has countless clinics in and around Chicago. The key challenge for patients here was new locations arising frequently, and attempting to coordinate visits to doctors from work, home, and sometimes children’s school locations. I created both a list view and map view of clinics to help users with varying levels of familiarity with Chicago. Many patients come in from around the country, so we had to account for that fact.</p>
